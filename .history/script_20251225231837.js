...
// Try to get home button (user needs to add this to HTML)
...
function createStandardQuestion(question) {
    ...
    // The optionLetter logic is now only used for data attributes, not displayed in a bubble
    return `
        <div class="question-item">
            ...
            <div class="options">
                ${question.options.map((option, index) => {
                    const optionLetter = String.fromCharCode(65 + index); // Used for data-option
                    return `
