const quizData = [
  ...
  // Part 4: Paragraph Completion (41-45)
  {
    "id": 41,
    "part": 4,
    "question": "昨天晚上我覺得很不舒服，______（41），所以很早就睡覺了。",
    "image": "",
  ...
  },
  {
    "id": 43,
    "part": 4,
    "question": "我去看病，醫生說我感冒了，給了我一些藥，______（43）要多休息，多喝水，才會快點好。",
    "image": "",
    "options": ["還告訴我", "頭有點兒痛", "很容易生病", "覺得很舒服", "更不舒服了", "多注意自己的身體"],
    "answer": "A",
    "remark": "Paragraph 1"
  },
  {
    "id": 44,
    "part": 4,
    "question": "這幾天的天氣一會兒熱，一會兒冷，______（44）。",
    "image": "",
    "options": ["還告訴我", "頭有點兒痛", "很容易生病", "覺得很舒服", "更不舒服了", "多注意自己的身體"],
    "answer": "C",
    "remark": "Paragraph 1"
  ...
  // Part 5: Reading Comprehension (46-50)
  {
    "id": 46,
    "part": 5,
    "question": "曾有一項調查發現，很多員工生病的時候不敢請假，因為他們擔心老闆會不高興，覺得他們沒有責任感。有人認為，員工會這麼想是公司的責任。一個好的公司應該能照顧員工，而不是讓他們拿健康去換錢。因此，讓員工有幸福感，應該是未來企業努力的方向。<br/>D: 這篇文章說了什麼內容？",
    "image": "",
  ...
  },
  {
    "id": 47,
    "part": 5,
    "question": "如果你每天都覺得身體很累，有一份報告或許可以告訴你原因。這份報告提到了下面幾種可能：不愛運動、水喝得不夠多、總是把事情想得太壞、不吃早餐、吃太多沒營養的食物等。以上幾點，只要簡單思考一下自己符合了幾項，再試著做出一些改變，想讓自己更健康一點也不難。<br/>D: 在改善健康方面，下面哪一個是作者的建議？",
    "image": "",
  ...
  },
  {
    "id": 48,
    "part": 5,
    "question": "從前有一個地方很久都不下雨，人們不管怎麼求雨都沒有用。有一次，他們從很遠的地方，請來一位有智慧的老人，希望他可以幫幫忙。老人在附近走了走、看了看，然後告訴他們，請蓋一間小屋，讓他住進去三天，三天當中，他任何人都不見。結果，三天後真的下雨了。大家都問他是怎麼做到的，他只回答，只要自己的心安靜了，外面就安靜了，所以下雨了。<br/>D: ",
    "image": "",
  ...
  },
  {
    "id": 49,
    "part": 5,
    "question": "說到錢，每個人對它的想法、使用方式和重視程度都不一樣。有人說：「錢是沒有性格的，它在誰的手上就像誰」。這句話說得很有道理，人們因為對錢的看法不同，而選擇不同的生活方式。比方說，有的人喜歡看到銀行裡的數字不斷增加，所以每天努力工作，很少花錢；有的人覺得錢只要夠用就好，不必太在意工作，因為「自己的時間」，也是一種看不到的「錢」。<br/>D: ",
    "image": "",
  ...
  },
  {
    "id": 50,
    "part": 5,
    "question": "以前，電影院的門口常常出現一個牌子，要觀眾別帶外面買的食物進去，如果想吃東西，只能買電影院裡賣的食物。後來，新聞說，觀眾其實可以拒絕配合這些電影院的規矩。說到這個問題，我認為，電影院的要求不是沒有道理，因為電影結束以後，他們還得打掃那些垃圾。其次，如果有人帶了一些有奇怪味道的食物進電影院，也很容易影響其他看電影的人。<br/>D: ",
    "image": "",
    "options": ["應該要避免吃有特別味道的東西", "覺得吃什麼東西都是個人的自由", "認為電影院的要求沒有任何道理", "看電影的人都有責任要打掃垃圾"],
    "answer": "A",
    "remark": "作者對在電影院裡吃東西的行為怎麼看？"
  }
];